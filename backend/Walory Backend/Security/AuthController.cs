...
namespace Walory_Backend.Security
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(RegisterDto dto)
        {
            ...
            var confirmationLink = $"{Request.Scheme}://localhost:80/confirm-email?userId={user.Id}&code={user.EmailConfirmationCode}";
        ...
        public async Task<IActionResult> ForgotPassword([FromBody] string email)
        {
            ...
            var resetLink = $"{Request.Scheme}://localhost:80/auth/reset-password?userId={user.Id}&code={user.PasswordResetCode}";
        ...
        public async Task<IActionResult> RequestEmailChange([FromBody] string newEmail)
        {
            ...
            var confirmationLink = $"{Request.Scheme}://localhost:80/auth/confirm-email-change?userId={user.Id}&token={user.EmailChangeCode}";
