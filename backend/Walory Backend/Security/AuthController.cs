...
namespace Walory_Backend.Security
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(RegisterDto dto)
        {
            ...
            var confirmationLink = $"http://walory.northeurope.cloudapp.azure.com/confirm-email?userId={user.Id}&code={user.EmailConfirmationCode}";
        ...
        public async Task<IActionResult> ForgotPassword([FromBody] string email)
        {
            ...
            var resetLink = $"http://walory.northeurope.cloudapp.azure.com/auth/reset-password?userId={user.Id}&code={user.PasswordResetCode}";
        ...
        public async Task<IActionResult> RequestEmailChange([FromBody] string newEmail)
        {
            ...
            var confirmationLink = $"http://walory.northeurope.cloudapp.azure.com/auth/confirm-email-change?userId={user.Id}&token={user.EmailChangeCode}";
